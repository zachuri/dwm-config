...
static const char *fonts[]          = { "CaskaydiaCove NF:size=9", "fontawesome:size=9" };
static const char dmenufont[]       = "CaskaydiaCove NF:size=9";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Down,   viewtoleft,     {0} },
	{ MODKEY,                       XK_Up,  viewtoright,    {0} },
